...
def predict():
    if request.method == "POST":
        ...
        if (Source == 'Cochin'):
            ...
            # print(Total_stops,Journey_day,Journey_month,Dep_hour,Dep_min,Arrival_hour,
        ...
        return render_template('index.html',prediction_text="Your Flight price is Rs. {}".format(
            output 
            ))
