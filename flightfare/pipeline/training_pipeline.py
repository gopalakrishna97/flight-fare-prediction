...
from flightfare.components.model_evaluation import ModelEvaluation
from flightfare.components.model_pusher import ModelPusher
def start_training_pipeline():
    try:
        ...
        model_pusher = ModelPusher(model_pusher_config,data_transformation_artifact,model_trainer_artifact,model_eval_artifact)
